...
<head>
    ...
    <script type="text/javascript">
        ...
        function openStoreAddDialog() {
            $("#dlg").dialog("open").dialog("setTitle", "添加物业费信息");
            url = "${pageContext.request.contextPath}/wuyefei/addwuyefei.do";
        }
        ...
        function openCategoryModifyDialog() {
            ...
            $('#fm').form('load', row);
            url = "${pageContext.request.contextPath}/wuyefei/updatewuyefei.do?id=" + row.id;
        ...
        function deleteCategory() {
            ...
            $('#fm').form('load', row);
            url = "${pageContext.request.contextPath}/wuyefei/deletewuyefei.do?id=" + row.id;
            $.messager
            .confirm(
                    "系统提示",
...
<table id="dg" title="费用管理" class="easyui-datagrid" pagination="true"
       ...
       url="${pageContext.request.contextPath}/wuyefei/findwuyefeilist.do" toolbar="#tb">
