...
<head>
    ...
    <script type="text/javascript">
        ...
        function openStoreAddDialog() {
            $("#dlg").dialog("open").dialog("setTitle", "添加投诉信息");
        ...
        function openCategoryModifyDialog() {
            ...
            $('#fm').form('load', row);
            url = "${pageContext.request.contextPath}/tousu/updatetousu.do?id=" + row.id;
            $.messager
            .confirm(
                    "系统提示",
        ...
        function deleteCategory() {
            ...
            var row = selectedRows[0];                                      	
            $('#fm').form('load', row);
            url = "${pageContext.request.contextPath}/tousu/deletetousu.do?id=" + row.id;
            $.messager
            .confirm(
                    "系统提示",
...
<table id="dg" title="投诉管理" class="easyui-datagrid" pagination="true"
       ...
       url="${pageContext.request.contextPath}/tousu/untousu.do" toolbar="#tb">
    ...
    <div>
       <!--  <a href="javascript:openStoreAddDialog()"
        ...
        <a
            ...
            class="easyui-linkbutton" iconCls="icon-edit" plain="true">标记为处理完成</a> 
        <a
