...
<head>
    ...
    <script type="text/javascript">
        ...
        function openStoreAddDialog() {
            ...
            url = "${pageContext.request.contextPath}/zichan/addzichan.do";
        }
        ...
        function openCategoryModifyDialog() {
            ...
            $('#fm').form('load', row);
            url = "${pageContext.request.contextPath}/zichan/updatezichan.do?id=" + row.id;
        ...
        function deleteCategory() {
            ...
            $('#fm').form('load', row);
            url = "${pageContext.request.contextPath}/zichan/deletezichan.do?id=" + row.id;
            $.messager
            .confirm(
                    "系统提示",
...
<table id="dg" title="资产管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:20"
       url="${pageContext.request.contextPath}/zichan/zichanlist.do" toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="10%" align="center" hidden="true">编号</th>
        <th field="mingcheng" width="200" align="center">名称</th>
        <th field="suoyouzhe" width="200" align="center">所有者</th>
        <th field="weihuzhe" width="200" align="center">维护者</th>
        <th field="weizhi" width="300" align="center">位置</th>
...
<div id="dlg" class="easyui-dialog"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>名称：</td>
                <td><input type="text" id="mingcheng" name="mingcheng"
            ...
            <tr>
                <td>所有者：</td>
                <td><input type="text" id="suoyouzhe" name="suoyouzhe"
                           class="easyui-validatebox" required="true"/>&nbsp;<font
                        color="red">*</font>
                </td>
            </tr>
             <tr>
                <td>维护者：</td>
                <td><input type="text" id="weihuzhe" name="weihuzhe"
                           class="easyui-validatebox" required="true"/>&nbsp;<font
                        color="red">*</font>
                </td>
            </tr>
             <tr>
                <td>位置：</td>
                <td><input type="text" id="weizhi" name="weizhi"
                           class="easyui-validatebox" required="true"/>&nbsp;<font
                        color="red">*</font>
                </td>
            </tr>
