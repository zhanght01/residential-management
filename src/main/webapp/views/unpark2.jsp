...
<head>
    ...
    <script type="text/javascript">
        ...
        function openCategoryModifyDialog() {
            ...
            $("#dlg").dialog("open").dialog("setTitle", "添加所有人信息");
            $('#fm').form('load', row);
...
<table id="dg" title="车位管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:20"
       url="${pageContext.request.contextPath}/park/unpark.do" toolbar="#tb">
...
<!-- <div id="tb">
    <div>
        ...
        <a
            ...
            class="easyui-linkbutton" iconCls="icon-edit" plain="true">标记为已使用</a> 
        <a
